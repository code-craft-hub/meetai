...
export const DashboardTrial = () => {
  ...
  return (
    <div className="border border-border/10 rounded-lg w-full bg-sidebar flex flex-col gap-y-2">
      ...
      <Button
        className="bg-foreground border-t border-border/10 rounded-t-none"
        asChild
      >
